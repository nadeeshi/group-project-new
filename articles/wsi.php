...
<body onload="initDoc();">
<div>
<?php include "../mainhome/mainnav.php"; ?> </div>
<div>
<?php include "../mainhome/footer3.php" ; ?> </div>
...
<div class="row">
        <div class="col-md-6 col-md-offset-4 well" style="align-content: center;">
            <form name="compForm" method="post" action = "<?php $_PHP_SELF ?>" onsubmit="if(validateMode()){this.myDoc.value=oDoc.innerHTML;return true;}return false;">
                <fieldset>
...
<input type="hidden" name="myDoc" id="content">
<div id="toolBar1">
