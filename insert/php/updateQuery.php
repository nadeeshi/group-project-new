...
height: 2515px !important;
    ...
    <div class="row">
        ...
        <div >
            ...
            <button id="edit_btn" class="edit_btn my-button" name="edit" onclick="myFunction()"/>Edit </button><br><br>
    
         </div>
         
         
            <form  id="form"  action="updateQuery.php" method ="post">
                    ...
                    <div class="container-form">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name ="scientific_name" class="form-control my-text" id="scientific_name" aria-describedby="sname" value=' . $row["scientific_name"] . ' disabled/ >
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control my-text" name="bat_order" id="order" aria-describedby="order" value=' . $row["bat_order"] . ' disabled/>
                        </div>

                        <div class="form-group ">
                            <label class= "lbl">Kingdom</label>
                            <input type="text" class="form-control my-text" name="kingdom" id="kingdom" aria-describedby="kingdom" value=' . $row["kingdom"] . ' disabled/>

                        </div>
                         <div class="form-group ">
                            <label class= "lbl">Genus</label>
                            <input type="text" class="form-control my-text" name= "genus" id="genus" aria-describedby="genus" value=' . $row["genus"] . ' disabled/>
                        </div>
                        <div class="form-group ">
                            <label class= "lbl">Phylum</label>
                            <input type="text" class="form-control my-text" name="phylum" id="phylum" aria-describedby="phylum" value=' . $row["phylum"] . ' disabled/>

                        </div>

                        <div class="form-group ">
                            <label class= "lbl">Family</label>
                            <input type="text" class="form-control my-text" name="family" id="family" aria-describedby="family" value=' . $row["family"] . ' disabled/ >
                        </div>
                        <div class="form-group ">
                            <label class= "lbl">Sub Family</label>
                            <input type="text" class="form-control my-text" name= "sub_family" id="sbfamily" aria-describedby="sbfamily" value=' . $row["sub_family"] . ' disabled/>

                        </div>

                        <div class="form-group ">
                            <label class= "lbl">Class</label>
                            <input type="text" class="form-control my-text" name="bat_class"  id="class" aria-describedby="class" value=' . $row["bat_class"] . ' disabled/>
                        </div>
                        <div class="form-group">
                            <label class= "lbl">Species</label>

                            <input type="text" class="form-control my-text" name= "species" id="species" aria-describedby="species" value=' . $row["species"] . ' disabled/>
                        </div>
                    ...
                    <div class="form-group ">
                        ...
                        <textarea class="form-control my-text" name="common_names" id="cnames" rows="4" cols="50"  disabled/>' . $row["common_names"] . ' </textarea>
                    ...
                    <div class="form-group">
                        <label class= "lbl">Roost Types</label>

                        <textarea class="form-control my-text" name="roost" id="roost" rows="4" cols="20"  disabled/ > ' . $row["roost"] . '</textarea>

                    </div>

                    <div class="form-group">
                        <label class= "lbl">Conservation Status</label>
                        <input type="text" class="form-control my-text" name="conservation_status" id="conservation_status" aria-describedby="redlist" value=' . $row["conservation_status"] . ' disabled/>
                    </div>
                    <div class="form-group">
                        <label class= "lbl">Countries Occurrence</label>
                        <textarea class="form-control my-text" name="country_occurence" id="occurence" rows="4" cols="20" disabled/>' . $row["country_occurence"] . ' </textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control my-text" name="feeding" id="food" rows="4" cols="50"  disabled/> ' . $row["feeding"] . '</textarea>

                    </div>

                    <div class="form-group">
                        <label class= "lbl">Breeding & Habbits</label>
                        <textarea class="form-control my-text" name="breeding" id="breeding" rows="4" cols="20"  disabled/>' . $row["breeding"] . '</textarea>
                    </div>
                    <div class="form-group">
                        <label class= "lbl">Major Threats</label>
                        <textarea class="form-control my-text" name= "threats" id="threats" rows="4" cols="20" disabled/ >' . $row["threats"] . '</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control my-text" name="measurements" id="measurements" rows="4" cols="20"  disabled/>' . $row["measurements"] . '</textarea>
