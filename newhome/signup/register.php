            ...
            <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="age" placeholder="dd/mm/yyyy" required value="<?php if($error) echo $age; ?>" class="form-control" />
                        <span class="text-danger"><?php if (isset($name_error)) echo $name_error; ?></span>
                    </div>

                    <div class="form-group">
                        <label for="gender">Gender</label><br>
                        Male&nbsp<input type="radio" name="gender" value="male" required value="<?php if($error) echo $gender; ?>" /><br>
                        Female&nbsp<input type="radio" name="gender" value="female" required value="<?php if($error) echo $gender; ?>"  />
                        <span class="text-danger"><?php if (isset($name_error)) echo $name_error; ?></span>
                    </div>
