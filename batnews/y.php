	...
	<div class="s">
        <div class="row">
          <div class="col-md-6">
			 ...
			 <div class="moduletable">
					...
					<div class="aidanews2_main" >
					<div class="aidanews2_mainL">
					<a class="aidanews2_img1" href=<?php echo "'z.php?photoid=".$id[2]."'"; ?>>
					...
					<a href=<?php echo "'z.php?photoid=".$id[2]."'"; ?> class="readon">
					<span class="aidanews2_readmore">Read More</span>
					</a>
					</div>
					</div>					
		...
		<div class="col-md-6">
			 ...
			 <div class="moduletable">
					...
					<div class="aidanews2_main" >
					<div class="aidanews2_mainL">
					<a class="aidanews2_img1" href=<?php echo "'z.php?photoid=".$id[3]."'"; ?>>
					...
					<div class="aidanews2_mainC">
					<h1 class="aidanews2_title latest-news">
					<a href=<?php echo "'z.php?photoid=".$id[3]."'"; ?>><?php echo $caption[3]; ?></a>
					</h1>
					<span class="aidanews2_text">
					<?php echo substr($desc[3],0,150)."..."; ?>
					</span>
					<a href=<?php echo "'z.php?photoid=".$id[3]."'"; ?> class="readon">
					<span class="aidanews2_readmore">Read More
					</span>
					</a>
					</div>
